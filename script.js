...
window.addEventListener("load", ()=>{
    ...
    },1000); //miliseconds in setTimeout

    //All calues must be "00" at first, there is more than one method for this 
    //1.method
...
birthdayInput.addEventListener("change", (event)=> {
    ...
    if(selectedBirthday > new Date()){ // new Date is meaning current date as default
        alert("Your birthday can not be greater than today.");
        return; 
    }
